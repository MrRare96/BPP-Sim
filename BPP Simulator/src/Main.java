...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Bin bin3 = new Bin(10);
        Bin bin4 = new Bin(10);
//        Bin bin5 = new Bin(((binWspacing * 5) + binWidth * 4), binHspacing, binWidth, binHeight, 10);
...
//        bin6.addPacket(packet5);
        ...
        Drawer draw1 = new Drawer(bin1, bin2, binHeight, binWidth);
